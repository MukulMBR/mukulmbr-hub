...
export const PROJECTS: Project[] = [
  {
    ...
    description: 'A hybrid direct-to-consumer and business-to-business retail mill supply store. Features visual weight switching, dynamic quote calculators, and direct WhatsApp integrations.',
    category: 'web',
  ...
  },
  {
    ...
    description: 'A modern, highly accessible dental clinic landing page for Dr. Mukul (MDS OMFS) located in Bengaluru. Displays treatments, services, and appointment bookings.',
    category: 'web',
